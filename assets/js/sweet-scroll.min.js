...
!function (t, n) {
    ...
    function y() {
        var t = _t.outerWidth, n = _t.innerWidth;
        return t ? t / n : 1
    }
    ...
    function I(t) {
        return g(t) ? {
            viewport: {width: gt(_t.innerWidth, xt.documentElement.clientWidth), height: _t.innerHeight},
            size: O()
        } : {viewport: {width: t.clientWidth, height: t.clientHeight}, size: w(t)}
    }

    function _(t) {
        var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "y", e = k(t);
        return e ? e[Et[n]] : t[Lt[n]]
    }

    function x(t, n) {
        var e = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "y", i = k(t), o = "y" === e;
    ...
    function L(t) {
        ...
        if (e.width || e.height) {
            var i = {}, o = null;
            if (null == n || g(n))o = t.ownerDocument.documentElement, i.top = _t.pageYOffset, i.left = _t.pageXOffset; else {
                o = n;
    ...
    }(), bt = ct(2, 53) - 1, Ct = ["Boolean", "Number", "String", "Function", "Array", "Object"], wt = {};
    ...
    var Ot = !("undefined" == typeof window || !window.document || !window.document.createElement), It = function () {
        ...
        y: "scrollTop",
        x: "scrollLeft"
    }, Et = {y: "pageYOffset", x: "pageXOffset"}, At = Object.freeze({
        linear: M,
        InQuad: R,
        OutQuad: T,
        InOutQuad: z,
        ...
        InBounce: lt,
        InOutBounce: ut
    }), Mt = ["ms", "moz", "webkit"], Rt = 0, Tt = Ot ? _t.requestAnimationFrame : null, zt = Ot ? _t.cancelAnimationFrame : null;
    if (Ot) {
    ...
    var Dt = function () {
        ...
        return kt(t, [{
            ...
            key: "stop", value: function () {
                var t = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0], n = this.options.complete;
            ...
            key: "_loop", value: function (t) {
                ...
                var e = this.el, i = this.props, o = this.options, r = this.startTime, l = this.startProps, u = this.easing, a = o.duration, c = o.step, h = {}, f = t - r, p = gt(1, vt(f / a, 0));
                s(i, function (t, n) {
                    var e = l[n], i = t - e;
                    if (0 === i)return !0;
                    var o = u(p, a * p, 0, 1, a);
            ...
            key: "calcStartProps", value: function (t, n) {
                ...
                if (this.options.quickMode) {
                    var i = I(this.el), o = i.viewport, r = o.width, l = o.height;
        ...
        function t() {
            var n = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "body, html";
        ...
        return kt(t, [{
            ...
            key: "getScrollOffset", value: function (t, n) {
                var i = this.container, o = this.header, r = this.parseCoodinate(n.offset), l = this.parseCoodinate(t);
                if (!l && e(t))if ("#" === t)l = {top: 0, left: 0}; else {
                    var u = p(t), a = L(u, i);
                    if (!a)return;
                    l = a
                }
            ...
            key: "normalizeScrollOffset", value: function (t, n) {
                var e = this.container, i = c({}, t), o = I(e), r = o.viewport, l = o.size;
            ...
            key: "to", value: function (t) {
                ...
                if (!this.isSSR) {
                    var o = this.container, r = c({}, this.options, i), l = this._trigger, u = e(t) && /^#/.test(t) ? t : null;
            ...
            key: "toTop", value: function (t) {
                ...
                this.to(t, c({}, n, {verticalScroll: !0, horizontalScroll: !1}))
            }
        }, {
            key: "toLeft", value: function (t) {
                var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                this.to(t, c({}, n, {verticalScroll: !1, horizontalScroll: !0}))
            }
        }, {
            key: "toElement", value: function (t) {
                var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                if (!this.isSSR)if (t instanceof Element) {
            ...
            key: "beforeScroll", value: function (t, n) {
                return !0
            }
        }, {
            ...
            key: "parseCoodinate", value: function (t) {
                var n = this._options ? this._options.verticalScroll : this.options.verticalScroll, i = {
                    top: 0,
                    left: 0
                };
                if (a(t, "top") || a(t, "left"))i = c(i, t); else if (o(t))2 === t.length ? (i.top = t[0], i.left = t[1]) : (i.top = n ? t[0] : 0, i.left = n ? 0 : t[0]); else if (l(t))i.top = n ? t : 0, i.left = n ? 0 : t; else {
                    if (!e(t))return null;
                    var r = h(t);
                    if (/^\d+,\d+$/.test(r))r = r.split(","), i.top = r[0], i.left = r[1]; else if (/^(top|left):\d+,?(?:(top|left):\d+)?$/.test(r)) {
                        var u = r.match(/top:(\d+)/), s = r.match(/left:(\d+)/);
                        i.top = u ? u[1] : 0, i.left = s ? s[1] : 0
                    } else {
                        if (!this.container || !/^(\+|-)=(\d+)$/.test(r))return null;
                        var f = _(this.container, n ? "y" : "x"), p = r.match(/^(\+|-)=(\d+)$/), d = p[1], v = parseInt(p[2], 10);
            ...
            key: "getContainer", value: function (t) {
                var n = this.options, e = n.verticalScroll, i = n.horizontalScroll, o = null;
            ...
            key: "handleContainerClick", value: function (t) {
                for (var n = this.options, e = t.target; e && e !== xt; e = e.parentNode)if (v(e, n.trigger)) {
                    var i = e.getAttribute("data-scroll"), o = this.parseDataOptions(e), r = i || e.getAttribute("href");
